...
public class CreateExplosion extends Canvas {
	 ...
	 **************************/
	CreateExplosion() {
		img_fire_a = getToolkit().getImage("img/fire_a@x64y64.png"); //爆発系
		img_fire_b = getToolkit().getImage("img/fire_b@x64y64.png"); //爆発系
		img_fire_c = getToolkit().getImage("img/fire_c@x64y64.png"); //爆発系
		img_fire_d = getToolkit().getImage("img/fire_d@x64y64.png"); //爆発系
		img_fire_e = getToolkit().getImage("img/fire_e@x64y64.png"); //爆発系
		img_fire_f = getToolkit().getImage("img/fire_f@x64y64.png"); //爆発系
		img_fire_g = getToolkit().getImage("img/fire_g@x64y64.png"); //爆発系
		fireStep = 0;
	}
